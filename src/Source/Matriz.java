...
//Constructures sobrecargados
     ...
     * @return String con las filas y las columnas de la matriz debidamente
     * ordenadas.
     */
     ...
     * @param mA factor A
     * @param mB factor B
     * @return mAxmB La matriz de retorno tiene dimensions [fA]x[cB]
     */
     ...
     * @param m1 Matriz 1
     * @param m2 Matriz 2
     * @return Devuelve una matriz con las mismas dimensiones con los productos
     * de los elementos de cada matriz
     */
